...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        countries  += ["India","Africa","USA","Japan","Denmark","China","Srilanka","Canada","Australia","Austria","Algeria","Zimbambe"]
    ...
    func shadow(){
    viewContent.layer.shadowColor = #colorLiteral(red: 0.3098039329, green: 0.2039215714, blue: 0.03921568766, alpha: 1)
